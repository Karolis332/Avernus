...
- **Current PCs:**
  - **Drenwal** — Light Cleric. Hellrider, child of Bhaal. Gargauth tempts him via the Shield. Primary healer/support/frontline. Warding Flare, Radiance of the Dawn, Divine Intervention (hijacked by Bhaal).
  - **Aurora** — Archfey Warlock. Linked to the Moonkite (her patron). Wand of Celestial Warding (evolving). Fey Presence, Misty Escape. Sustained ranged DPS.
  - **Asimov** — Soulknife Rogue. Interdimensional bounty hunter. Genie companion Rasheem (fence/guildmaster). Soul Capacitor (evolving). Burst DPS, stealth, infiltration.
- **Companions:**
...
- The importance of the **blood cost** — powerful creature blood is needed
- **Zariel's Sword** is in the Bleeding Citadel and is the key to freeing Elturel
- **Kostchtchie's Maw** exists (freeing the demon lord can distract Zariel)
- The **Solar's Helmet** exists
- **Drenwal's brother Dumal** and another Bhaalspawn are in Hell
- Drenwal **severed his amulet connection** — they cannot be tracked (but also cannot track Dumal)
...
- Met Mad Maggie, completed the Dream Quest (5 phases with saves)
- Dream revealed the Fallen Three and hinted at Intermediaries
- Party has the Shield of the Hidden Lord (Gargauth)
- Defeated Bloodbath the Drinker of Gore (absorbed by Rasheem)
- Found the Moonkite Cage Key
- Traveled to the Tower of Urm
- Defeated Mordenkainen's simulacrum at the Tower
- Met the real Mordenkainen (second Tower of Urm)
...
**Events:**
- Party traveled to the Tower of Urm to meet Mordenkainen (intermediary quest)
- Encountered and **defeated Mordenkainen's simulacrum** at the Tower
- Party noticed the Mordenkainen they were speaking with was **glitching and dripping water** — realized it was a simulacrum
- The **real Mordenkainen** was in a second Tower of Urm — he could never catch up to his simulacrum
- Real Mordenkainen met the party and provided crucial information:
  - **Fallen Three locations** — the party now knows where to find Olanthius, Haruman, and Bel
  - **Drenwal's cure:** To be rid of his Bhaal blood/sickness, Drenwal must **"die and be reborn in the eyes of another god"**
- Mordenkainen thanked them for dealing with the simulacrum
**Consequences:** Intermediary quest with Mordenkainen complete — party has the Fallen Three locations without needing blood pay (or with reduced cost). Drenwal's cure is now a known path but raises massive questions: which god? How to die safely? Who performs the rebirth? Gargauth will try to position himself as the answer. The party must now choose: pursue the Moonkite at the Palace of Gore (Aurora's arc) or head to the Fallen Three (main quest).
